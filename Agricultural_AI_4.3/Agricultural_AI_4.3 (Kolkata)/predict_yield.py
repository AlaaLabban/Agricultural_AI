    ...
    def predict(self, future_weather_df):
        ...
        for crop_type in self.crop_parameters.keys():
            if crop_type in self.models:
                ...
                X_future = features_df[model_data['features']].fillna(0)
                ...
                print(f"  🌱 Predicted Yield for {crop_type} in {year}: {predicted_yield:.2f} tons/ha")
...
def main():
    try:
        ...
        print("❌ Error: 'future_weather_data.csv' not found. Please create this file with your weather forecast.")
        return
